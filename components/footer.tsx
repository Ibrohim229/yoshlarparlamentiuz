        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/yoshlar-parlamenti/tarixi" className="hover:underline">
                  Yoshlar parlamenti tarixi
                </Link>
              </li>
              <li>
                <Link href="/yoshlar-parlamenti/rahbariyati" className="hover:underline">
                  Yoshlar parlamenti rahbariyati
                </Link>
              </li>
              <li>
                <Link href="/yoshlar-parlamenti/kengashi" className="hover:underline">
                  Yoshlar parlament kengashi
                </Link>
              </li>
              <li>
                <Link href="/yoshlar-parlamenti/qomitalar" className="hover:underline">
                  Yoshlar parlamenti qo'mitalar
                </Link>
              </li>
              <li>
                <Link href="/yoshlar-parlamenti/nizomi" className="hover:underline">
                  Yoshlar parlamenti nizomi
                </Link>
              </li>
              <li>
                <Link href="/yoshlar-parlamenti/parlamentning-yoshlar-guruxlari" className="hover:underline">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/tadbirlar/yalpi-majlislar" className="hover:underline">
                  Yalpi majlislar
                </Link>
              </li>
              <li>
                <Link href="/tadbirlar/siyosiy-partiyalar" className="hover:underline">
                  Siyosiy partiyalarning yoshlar guruhlari
                </Link>
              </li>
              <li>
                <Link href="/tadbirlar/qomitalar-yigilishi" className="hover:underline">
        ...
        <div className="mt-8 pt-4 border-t border-blue-800 flex flex-col md:flex-row justify-between items-center text-sm">
          <div>
            ...
            <div className="flex items-center mt-1">
              <Image src="/images/logos/cc-logo.png" alt="Creative Commons" width={80} height={20} />
              <p className="ml-2">
                Saytdagi barcha materiallardan quyidagi litsenziya bo'yicha foydalanish mumkin: Creative Commons
